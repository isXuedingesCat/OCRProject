...
from ocrcore.data.imaug.iaa_augment import IaaAugment
from ocrcore.data.imaug.random_crop_data import is_poly_outside_rect
from ocrcore.infer.utility import get_rotate_crop_image
